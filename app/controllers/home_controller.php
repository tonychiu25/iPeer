<?php
/* SVN FILE: $Id: home_controller.php 734 2011-10-03 20:47:56Z compass $ */
...
class HomeController extends AppController
{
   ...
   * @var $uses
   */
  var $uses =  array('DepartmentCourse' ,'Department' ,'DepartmentUser' ,'UserEnrol', 'Group', 'GroupEvent', 'User', 'UserCourse', 'Event', 'EvaluationSubmission', 'Course', 'Role','UserEnrol', 'Rubric', 'Penalty');
