<?php
/* SVN FILE: $Id: event.php 731 2011-09-01 23:42:09Z compass $ */
...
class Event extends AppModel
{
  ...
  //Validation check on duplication of title
    ...
    if ($result =  $this->find('all' , array('conditions'=>array('Event.title'=>$value), 'recursive' => 0))){
      $duplicate = true;
     }
   ...
   */
	...
	/**
	 * Returns all events corresponding to a course_id & event_template_type pairing
	 */
    function getEventTypeWithCourse($course_id = null, $event_template_type_id = null, $fields = array()) {
      return $this->find('list', array('conditions' => array('course_id' => $course_id, 
      							'event_template_type_id' => $event_template_type_id), 'fields' => $fields));	
    }
